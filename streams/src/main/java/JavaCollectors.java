...
public class JavaCollectors {
    public static void main(String[] args) {
        ...
        // summingInt(ToIntFunction) : returns a Collector that produces the sum of a interger-valued
        ...
        // joining() : is used to join various elements or a character of string array into a single string object
        ...
        // partitioning: is used to partition a stream of objects (or set of elements) based on a given predicate
        System.out.println("*************PartitioningBy()************");
        Map<Boolean, List<Dish>> veggieDish = DishData.getAll()
                .stream()
